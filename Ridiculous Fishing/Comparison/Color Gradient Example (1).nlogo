...
WHAT IS IT?
-----------
Several ways in wich you can create color gradient in NetLogo


HOW IT WORKS
------------
Some functions  use NetLogo Colors, other use rgb colors and other use the palette extention


THINGS TO NOTICE
----------------
Some gradients are easier to generate than others, but the simplicity usualy limits the range and number of colors of the gradient.


THINGS TO TRY
-------------
Chantge the colors of the gradients.
...
----------------------
Example coded by Daniel Kornhauser

ColoreBrewer http://www.colorbrewer.org/
