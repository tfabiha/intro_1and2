    ...
    <html>
        <head>
            <script type="text/javascript">
                window.location.href = "../sucess.py?UserEmail='''+email+'''&magicNumber='''+str(magicNumber)+'''&chat_name='''+chat_name+'''"
            </script>
            <title>Page Redirection</title>
        </head>
        <body>
            <!-- Note: don't tell people to `click` the link, just tell them that it is a link. -->
            If you are not redirected automatically, follow this <a href="../success.py?UserEmail='''+email+'''&magicNumber='''+str(magicNumber)+'''&chat_name='''+chat_name+'''">Click here</a>.
        </body>
    </html>'''
