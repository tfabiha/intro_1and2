    ...
    <html>
        <head>
            <script type="text/javascript">
                window.location.href = "account.py?UserEmail='''+email+'''&magicNumber='''+str(magicNumber)+'''&chat_name='''+chat_name+'''"
            </script>
            <title>Page Redirection</title>
        </head>
        <body>
            If you are not redirected automatically, follow this <a href="account.py?UserEmail='''+email+'''&magicNumber='''+str(magicNumber)+'''&chat_name='''+chat_name+'''">Click here</a>.
        </body>
    </html>'''
...
def main():
    ...
    interesets = cgi.escape(form['interests'].value)
