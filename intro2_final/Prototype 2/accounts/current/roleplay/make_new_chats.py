...
def main():
    ...
    chat_name = cgi.escape(form['chat_name'].value)
    chatname = "../chatstuff/chats/"+chat_name+".txt"
    ...
    character1 = cgi.escape(form['character1'].value)
    character2 = cgi.escape(form['character2'].value)
    user = form['user'].value

    if character1 == character2:
        print "You may not use the same name twice. Try again."
        return
