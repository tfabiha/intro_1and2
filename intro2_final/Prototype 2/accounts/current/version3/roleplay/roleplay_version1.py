...
def mainPage(email,magicNumber,chat_name,here):
    ...
    title = chat_name.join(text[0].split('the chat'))
    print title
    text = text[1:]
    newtext = ""
    if text == []:
    ...
    <body>
        ...
        <div id="login">
	<center>
        <h5 id="wel">'''+ title+'</h5>'+'<br>'+'<p id="chatters">'+newtext + '''</p>
        <p>
		...
		<input type="hidden" name="UserEmail" size="25" value="'''+email+'''">
                ...
                <input type="hidden" name="chat_name" size="25" value="'''+here+'''">

                <h5 id="wel">Choose Your Character:</h5><br>'''+choosechar+'''<br>
        ...
        <hr>
        <div id="login">
        <center><p id="wel">Or you can also...</p>
...
def main():
    ...
    print mainPage(email,magicNumber,chat_name,chat_name)            
main()
