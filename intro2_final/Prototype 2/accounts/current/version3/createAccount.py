...
def main():
    ...
    #append user avatar
    writeThis.append("http://i.imgur.com/1gHf6dO.png")
    writeThis.append("none")
    writeThis.append("none")
    ...
    writing = """<strong>Admins: <strong>Welcome to the world of Zompirates.
    <br> Hope you enjoy your stay."""
    
    posts = open('./posts/'+email+'.txt','w')
    posts.write(writing)
    posts.close()

    morewriting = 'Nothing here.\nNothing here.\nNothing here.\nNothing here.'
    accountinfo = open('./accountinfo/'+email+'.txt','w')
    accountinfo.write(morewriting)
    accountinfo.close()
