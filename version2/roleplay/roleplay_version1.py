...
def mainPage(email,magicNumber,chat_name):
    ...
    <body>
		...
		<input type="radio" name="character" value="'''+char1+'''" checked> '''+char1+'''<br>
                <input type="radio" name="character" value="'''+char2+'''"> '''+char2+'''<br><br><br>
        ...
        <a href="./roleplay.py?UserEmail='''+email+'''&magicNumber='''+str(magicNumber)+'''">Click here to go to the main page.</a>
        </div>
        </body>
        </html>
    '''
